...
**This .qmd is designed to create a professional html, but includes redundancies that make it sub par for using the function. Please use `habitat_suitability_function_streamlined.qmd' for a better experience making you habitat suitability maps.**
