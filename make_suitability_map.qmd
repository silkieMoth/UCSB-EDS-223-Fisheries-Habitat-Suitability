...
This .qmd contains all code to create the function, as well as use it. You can use this to create your own habitat suitability map and save it as a .png. Please see the documentation in `habitat_suitability_function.html` for more information.
...
-   Converted SST from kelvin to Celsius.
-   Cropped and re-sampled the depth raster to match the SST raster in depth and resolution.
...
### [Examples for using the function for mapmaking]{.underline}
